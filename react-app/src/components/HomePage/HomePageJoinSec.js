    ...
    <>
      <div className="home-page-join-sec">
        ...
        <button onClick={() => history.push("/signup")}>
          Sign up to access Legendhood
        </button>
        <img
          src="https://cdn.robinhood.com/assets/generated_assets/brand/_next/static/images/learn-phone__c458862ccad46260b6b1f604e0ad1173.png"
          alt="learn-the-basics"
        />
      </div>
      <div className="home-page-new-gen">
        <div className="new-gen-title">Join a new generation of investors</div>
