    ...
    useEffect(() => {
        if (STOCKLISTOBJ[symbol]) {
            ...
            const getUserLists = async () => {
                const res = await dispatch(loadWatchlists())
            }
            getUserLists()
            ...
            // setTimeLabels(datetimes.map((unixtime) => unixToDate(unixtime)));
            ...
            {isLoaded && (<div className="details-page-main-container">
                <div className="details-page-left-container">
                    ...
                    <div className="details-page-graph-container">
                        ...
                        {!liveDataAvailable && (
                            <div className="details-page-no-live-data">Market is currently closed. No live data available</div>
                        )}
                    </div>
